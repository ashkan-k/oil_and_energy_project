...
@section('content')
    <div class="auth-box">
        ...
        <!-- Form -->
            <div class="row">
                <form class="col s12" action="{{ route('reset_password.confirm') }}" method="post">
                @csrf
                <!-- email -->
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="code" type="text" value="{{ old('code') }}" class="validate" maxlength="6" name="code" required>
