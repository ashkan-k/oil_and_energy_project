...
@section('title')لیست دسته بندی محتوا ها@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    {{--                    <h4 class="card-title">لیست دسته بندی محتوا ها</h4>--}}
                    <h6 class="card-subtitle"></h6>
                    <div class="table-responsive">

                        <a href="{{ route('post_categories.create') }}" class="waves-effect waves-light btn btn-info">
                            دسته بندی محتوا جدید <i class="material-icons right">add</i>
                        </a>
                            ...
                            <table id="demo-foo-addrow"
                                ...
                                @foreach($objects as $item)
                                    <tr style="" class="footable-even">
                                        ...
                                        <td>
                                            <form action="{{ route('post_categories.destroy' , $item->id) }}"
                                                ...
                                                <a title="ویرایش" href="{{ route('post_categories.edit' , $item->id) }}"
