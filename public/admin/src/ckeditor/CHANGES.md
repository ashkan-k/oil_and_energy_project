...
* [#13409](https://dev.ckeditor.com/ticket/13409): Fixed: List elements incorrectly merged when pressing *Backspace* or *DeleteBlade*.
...
* [#12503](https://dev.ckeditor.com/ticket/12503): [Blink/Webkit] Fixed: Incorrect result of Select All and *Backspace* or *DeleteBlade*.
...
* [#12729](https://dev.ckeditor.com/ticket/12729): Fixed: Incorrect structure created when merging a block into a list item on *Backspace* and *DeleteBlade*.
...
* [#11960](https://dev.ckeditor.com/ticket/11960): [Blink/WebKit] Fixed: The caret should be scrolled into view on *Backspace* and *DeleteBlade* (covers only the merging blocks case).
...
* [#11861](https://dev.ckeditor.com/ticket/11861): [WebKit/Blink] Fixed: Span elements created while joining adjacent elements. **Note:** This patch only covers cases when *Backspace* or *DeleteBlade* is pressed on a collapsed (empty) selection. The remaining case, with a non-empty selection, will be fixed in the next release.
...
* [#10890](https://dev.ckeditor.com/ticket/10890): Fixed: Error thrown when pressing the *DeleteBlade* key in a list item.
* [#10055](https://dev.ckeditor.com/ticket/10055): [IE8-10] Fixed: *DeleteBlade* pressed on a selected image causes the browser to go back.
...
* [#10646](https://dev.ckeditor.com/ticket/10646): Removing a selected sublist or nested table with *Backspace/DeleteBlade* removes the parent element.
...
* [#10172](https://dev.ckeditor.com/ticket/10172): Pressing *DeleteBlade* or *Backspace* in an empty table cell moves the cursor to the next/previous cell.
